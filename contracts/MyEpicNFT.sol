...
/* 
    ...
    2. ❌ Alert user when they’re on the wrong network.
    3. 🐦 Add your Twitter
    4. 👀 Add a button to let people see the collection!
*/
...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] thirdWords = ["Het", "Helg", "Banan", "Herre", "Krake", "Orre"];
    ...
    function makeAnEpicNFT() public {
        require(
            _tokenIds.current() < 49,
            "Sorry the limit has been reached for this NFT"
        );
